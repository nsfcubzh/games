...
NSFLua['cubic-dungeons\\classes\\rarity_tiers.lua'] = {}
NSFLua['cubic-dungeons\\classes\\rarity_tiers.lua'].LAST_SECTION = ""
NSFLua['cubic-dungeons\\classes\\rarity_tiers.lua'].LAST_SECTION_LINE = 0
