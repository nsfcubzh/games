...
NSFLua['cubic-dungeons\\loading_screen.lua'] = {}
NSFLua['cubic-dungeons\\loading_screen.lua'].LAST_SECTION = ""
NSFLua['cubic-dungeons\\loading_screen.lua'].LAST_SECTION_LINE = 0
