...
NSFLua['cubic-dungeons\\modules\\weapon_visualizer.lua'] = {}
NSFLua['cubic-dungeons\\modules\\weapon_visualizer.lua'].LAST_SECTION = ""
NSFLua['cubic-dungeons\\modules\\weapon_visualizer.lua'].LAST_SECTION_LINE = 0
